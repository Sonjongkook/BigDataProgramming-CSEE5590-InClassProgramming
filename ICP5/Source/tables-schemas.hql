...
! ls /home/cloudera/Downloads/Dataset/employees/input/;

-- Now load the data!

LOAD DATA LOCAL INPATH '/home/cloudera/Downloads/Dataset/employees/input/' 
...
dfs -ls /user/hive/warehouse/db1.db/employees;
dfs -cat /user/hive/warehouse/db1.db/employees/*;
